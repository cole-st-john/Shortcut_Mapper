...
from objexplore import explore  # for development purposes

import keys
import active_app_windows as active_app_windows
from keys import Key_Rerouter, Keypress, Shortcut, Shortcut_Store
...
class ShortcutManagerApp(customtkinter.CTk):
    ...
    def create_set_shortcuts_elements(self):
        ...
        self.action_label = tk.Label(self.shortcuts_frame, text="Action (repr)")
        ...
        def update_context():
            ...
            for x in (
                active_app_windows.get_all_window_executables()
    ...
    def create_end_use_mode(self):
        ...
        self.end_use_mode_label = tk.Label(
    ...
    def activate_set_mode(self):
        ...
        self.list_of_executables = active_app_windows.get_all_window_executables()
        # self.create_set_shortcuts_elements()
    ...
    def record_key_sequence(self):
        ...
        self.action_textvar.set("---Record shortcut---")
        self.update()
        repr_recorded, self.events = keys.record_sequence()
        print("Recorded (copy and paste from here)", repr_recorded)
        self.recorded_text_textvar.set(repr_recorded)
        if repr_recorded:
            self.action_textvar.set("---Shortcut recorded---")
    ...
    def confirm_shortcut(self):
        ...
        action_input = self.recorded_text_textvar.get()
